    ...
    build.onLoad({ filter: /\.(js|ts)x(?:[?#].*)?$/ }, async (args) => {
      ...
      const transformed = await transformAsync(code, {
        ...
        presets: [
          ...
          // genes-ts emits `declare` class fields in generated support modules.
          // OpenTUI's stock preload does not enable this Babel option yet, so the
          // harness owns the same transform with the option explicit.
