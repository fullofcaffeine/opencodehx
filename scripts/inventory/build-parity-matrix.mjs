...
function directEvidence(path) {
  const exact = new Map([
    ...
    ["project/project.test.ts", ["partial", "src/opencodehx/smoke/ProjectRuntimeSmoke.hx; docs/project-runtime-parity.md", "project discovery, initGit, stable/cached git-root IDs, clone/bare cache behavior, updates/events, initialization timestamps, favicon discovery, and sandbox pruning are covered; persisted store migration and config/service integration remain deferred", "ProjectRuntimeSmoke project edge fixtures", "opencodehx-hic"]],
    ["project/vcs.test.ts", ["partial", "src/opencodehx/smoke/ProjectRuntimeSmoke.hx; docs/project-runtime-parity.md", "git repo discovery, core VCS commands, and explicit branch-change events are covered; native file watching and service bus integration remain deferred", "ProjectRuntimeSmoke VcsRuntime fixture", "opencodehx-hic"]],
    ...
    ["project/worktree.test.ts", ["partial", "src/opencodehx/smoke/ProjectRuntimeSmoke.hx; docs/project-runtime-parity.md", "worktree slug/unique naming, branch, create, ready/failed events, project-ID sharing, sandbox tracking, start commands, and reset/clean are covered; full instance bootstrap integration remains deferred", "ProjectRuntimeSmoke worktree edge fixture", "opencodehx-hic"]],
