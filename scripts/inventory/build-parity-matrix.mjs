...
function directEvidence(path) {
  const exact = new Map([
    ...
    ["session/message-v2.test.ts", ["partial", "src/opencodehx/smoke/MessageSmoke.hx; src/opencodehx/smoke/SessionProcessorSmoke.hx; docs/message-v2-port.md; docs/session-processor-one-turn.md", "full upstream model-message conversion and provider-transform cases remain partial; live AI SDK recovered history now covers text, compaction/subtask prompts, user file parts, assistant tool-call/tool-result parts, media-capable tool-result attachments, unsupported-provider synthetic media injection, interrupted tool output, and normal tool errors", "MessageSmoke codec/part/cursor fixtures plus SessionProcessorSmoke rich recovered-history prompt"]],
    [
