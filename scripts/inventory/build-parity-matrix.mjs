...
function directEvidence(path) {
  const exact = new Map([
    ...
    ["effect/run-service.test.ts", ["partial", "src/opencodehx/effect/RuntimeMemo.hx; src/opencodehx/effect/RunServiceRuntime.hx; src/opencodehx/smoke/EffectSmoke.hx; docs/effect-runtime-parity.md", "memoized shared dependency, Promise-backed service execution, typed exits, callback success/failure delivery, and deterministic fork success/failure/interruption are covered; full Effect ManagedRuntime/Layer/Context.Service and real Fiber semantics remain deferred", "EffectSmoke.runServiceMemoMap/runServiceAsync"]],
