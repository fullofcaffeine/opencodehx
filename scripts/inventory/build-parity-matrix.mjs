...
function directEvidence(path) {
  const exact = new Map([
    ...
    ["installation/installation.test.ts", ["partial", "src/opencodehx/smoke/ProjectRuntimeSmoke.hx; docs/project-runtime-parity.md", "installation method detection, latest-version lookup for unknown-method GitHub fallback plus GitHub/npm/bun/pnpm/brew/scoop/choco shapes, release-type classification, curl install-script upgrade planning, package-manager upgrade command planning, and package-manager uninstall command planning are covered with typed injected HTTP/process seams; real package-manager side effects remain deferred", "ProjectRuntimeSmoke installationRuntime fixture", m11Owners.foundation]],
