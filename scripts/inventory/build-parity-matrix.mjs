  ...
  const exact = new Map([
    ...
    [
      ...
      [
        ...
        "focused TUI config loader covers tui.json/global/env/project/.opencode precedence, nested tui flattening, keybind/plugin/plugin_enabled merges, tuple plugin options, Windows terminal suspend/input undo normalization, legacy opencode.json migration with backup/strip, and env/file substitution; dependency install side effects, readonly-strip fallback, and full TUI service/runtime layering remain deferred",
