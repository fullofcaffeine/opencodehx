...
function directEvidence(path) {
  const exact = new Map([
    ...
    ["effect/run-service.test.ts", ["partial", "src/opencodehx/effect/RuntimeMemo.hx; src/opencodehx/effect/RunServiceRuntime.hx; src/opencodehx/smoke/EffectSmoke.hx; docs/effect-runtime-parity.md", "memoized shared dependency and Promise-backed service execution are covered; full Effect ManagedRuntime/Layer/Context.Service plus runFork/runCallback remain deferred", "EffectSmoke.runServiceMemoMap/runServiceAsync"]],
