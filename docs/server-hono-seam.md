...
**Beads:** `opencodehx-026`, `opencodehx-027`, `opencodehx-jr4`
...
- `scripts/harness/package-smoke.mjs` now exercises the same listener through the globally installed package binary: `/health`, session create/list, message page read, `/tui/select-session`, and session abort.
