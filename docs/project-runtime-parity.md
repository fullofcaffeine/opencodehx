...
- NPM/install-adjacent behavior:
  ...
  - package `outdated` covers registry failure, malformed registry JSON, missing latest metadata, exact-version comparison, comparator satisfaction/escape, and caret/tilde/disjunction/wildcard semver ranges,
