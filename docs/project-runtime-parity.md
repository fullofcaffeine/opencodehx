...
- NPM/install-adjacent behavior:
  ...
  - package `outdated` covers registry failure, malformed registry JSON, missing latest metadata, exact-version comparison, comparator edge satisfaction/escape, wildcard satisfaction/escape, zero-major caret, tilde, and disjunction semver ranges,
