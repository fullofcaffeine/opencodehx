...
- NPM/install-adjacent behavior:
  ...
  - package `which` covers bin selection, scoped package bin names, string/object `package.json` bin declarations, stale cache lock removal, and absent-cache installation,
