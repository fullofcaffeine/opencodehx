...
- NPM/install-adjacent behavior:
  ...
  - package `outdated` covers registry failure, malformed registry JSON, missing latest metadata, exact-version comparison, and caret/comparator/wildcard semver range satisfaction,
