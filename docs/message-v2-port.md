...
Full upstream `MessageV2.toModelMessages(...)` parity is still partial. Remaining edges include provider-transform message cases beyond the focused live recovered-history smoke.
