...
- New and resumed CLI runs persist through the store when `OPENCODE_DB` is explicitly configured, making generated session IDs immediately exportable and resumed turns append-only.
