...
- `read` for file previews, line offsets/limits, directory listings with pagination, nearby instruction reminders, out-of-range offset errors, external-directory permission requests, missing-file suggestions, and binary-file rejection.
