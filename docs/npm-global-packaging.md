...
- installed `run --live-ai-sdk` evidence asserts the local OpenAI-compatible request path, bearer authorization header, and `stream: true` request body while avoiding external credentials;
