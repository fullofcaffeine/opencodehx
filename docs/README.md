...
- `storage-port.md`, `resource-imports.md`, `bus-runtime-parity.md`, `pty-runtime.md`, and `fixture-smoke-parity.md` cover storage persistence and JSON migration, host/runtime resources, event delivery, PTY lifecycle/WebSocket replay, and smoke tmpdir parity.
