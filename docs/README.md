...
- `mcp-acp-minimum.md`, `lsp-minimum.md`, and `plugin-runtime-minimum.md` cover the first MCP/ACP, LSP, and plugin runtime surfaces, including async plugin trigger awaiting.
