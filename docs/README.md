...
- `account-repo.md` covers the first SQLite-backed account repository seam: account row/state persistence, active org selection, token updates, and URL normalization.
