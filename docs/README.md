...
- `account-repo.md` covers the first SQLite-backed account repository and credential-free service seams: account row/state persistence, active org selection, token updates, URL normalization, config/org headers, and device-poll state mapping.
