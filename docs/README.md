...
- `config-port.md`, `permission-model-port.md`, `bash-shell-seam.md`, `patch-runtime.md`, `project-runtime-parity.md`, `formatter-port.md`, and `effect-runtime-parity.md` cover config loading, permissions, parser-backed bash permissions, the standalone patch namespace, project/git/sync foundations, formatting, observability resources, run-service memo behavior, and instance state.
