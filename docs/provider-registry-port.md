...
- Temperature, `topP`, `topK`, max-output-token helpers now shared by session compaction, upstream `smallOptions` defaults, and reasoning variant generation across the main upstream provider families.
