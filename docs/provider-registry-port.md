...
- `SessionProcessorSmoke` proves the live AI SDK middleware calls `ProviderTransform.message(...)` before `doStream`, including Anthropic empty-system filtering at the inspected provider prompt boundary.
