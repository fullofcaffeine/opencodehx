...
Current source-safety expectations include macro-checked built-in plugin routes, built-in keybind action references, and source-authored tool IDs, plus `npm run macro:diagnostics` as the negative compile gate for typo diagnostics.
