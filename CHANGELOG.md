...
Current TUI source-safety expectations include macro-checked built-in plugin routes and built-in keybind action references, plus `npm run macro:diagnostics` as the negative compile gate for typo diagnostics.
